# -*- coding: utf-8 -*-
"""
Created on Thu Apr 18 03:58:12 2019
...
# Sign in
# Sign up
# 1 3 17 bfaure/AI_Project_4
# Code  Issues 0  Pull requests 0  Projects 0  Insights
# Join GitHub today
# GitHub is home to over 31 million developers working together to host and review code, manage projects, and build software together.
#
# AI_Project_4/Question_4/main.py
# @bfaure bfaure added more verbose output for Q4
# 935d0ab on May 1, 2017
# 189 lines (156 sloc)  5.3 KB
#
    ...
    for epoch in range(nb_epoch):
        ...
        for i in range(len(matrix)):
            ...
            for j in range(len(weights)):  # calculate new weight for each node
                ...
                if verbose: print(round(weights[j], 2), "!!!!!!",
                                  activationvalue)  # sys.stdout.write("%0.5f\n" % (weights[j]))
...
def main():
    ...
    if part_A:  # 3 inputs (including single bias input), 3 weights
        ...
        matrix = [[1.00, 0.08, 1.0],
                  ...
                  [1.00, 0.70, 0.0],
                  [1.00, 0.92, 0.0]]
        weight_s = [0.20, 1.00]  # initial weights specified in problem
